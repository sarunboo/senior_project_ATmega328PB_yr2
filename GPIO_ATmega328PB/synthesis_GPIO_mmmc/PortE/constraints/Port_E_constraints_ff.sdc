...
report_clocks > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_clock_ff.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ff.rpt