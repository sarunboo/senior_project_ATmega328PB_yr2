...
set RTL_DIR     "/nfs/mcu8b/sarun/AES_syn/source"
...
read_hdl   -language sv ${TOP_DESIGN_NAME}.sv cbc_logic.sv SPI_slave.sv AES_main.sv aes_key_expand.sv round.sv lastround.sv subbytes.sv sbox.sv shiftrows.sv mixcolumn.sv
elaborate
init_design 
...
# report
report_timing     -nets -path_type full_clock -nworst 15 -view view_ff_v1p32  > report/${TOP_DESIGN_NAME}_ff_report_timing.rpt
report_timing     -nets -path_type full_clock -nworst 15 -view view_ss_v1p08_125c  > report/${TOP_DESIGN_NAME}_ss_report_timing.rpt
report_timing     -nets -path_type full_clock -nworst 15 -view view_tt_v1p5_25c  > report/${TOP_DESIGN_NAME}_tt_report_timing.rpt
