#################################################################################
#
# Created by Genus(TM) Synthesis Solution 23.10-p004_1 on Mon Apr 21 23:52:37 +07 2025
#
#################################################################################
...
create_constraint_mode -name functional_ss_v1p08_125c \
    -sdc_files { /nfs/mcu8b/sarun/AES_syn/constraints/aes_top_constraints_ss.sdc }
create_constraint_mode -name functional_ff_v1p32 \
    -sdc_files { /nfs/mcu8b/sarun/AES_syn/constraints/aes_top_constraints_ff.sdc }
create_constraint_mode -name functional_tt_v1p5_25c \
    -sdc_files { /nfs/mcu8b/sarun/AES_syn/constraints/aes_top_constraints_tt.sdc }
