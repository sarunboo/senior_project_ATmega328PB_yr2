...
# Generated by Genus(TM) Synthesis Solution 22.10-p001_1, revision 1.566
# Generated on: Wed Mar 12 23:47:09 +07 2025 (Wed Mar 12 16:47:09 UTC 2025)
...
set logfile fv/Port_C/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Port_C -revised fv_map
...
set env(RC_VERSION)     "22.10-p001_1"
set env(CDN_SYNTH_ROOT) "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86"
set env(CW_DIR) "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/cadence/DDI22.10.000/GENUS221/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /nfs/mcu8b/sarun/current_GPIO/portC/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /nfs/mcu8b/sarun/current_GPIO/portC/Port_C.sv /nfs/mcu8b/sarun/current_GPIO/portC/IO_Port.sv /nfs/mcu8b/sarun/current_GPIO/portC/rg_md.sv /nfs/mcu8b/sarun/current_GPIO/portC/synchronizer.sv
elaborate_design -golden -root {Port_C} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Port_C/fv_map.v.gz
elaborate_design -revised -root {Port_C}
...
#add_name_alias fv/Port_C/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Port_C.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Port_C.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Port_C.rtl.fv_map.rpt
