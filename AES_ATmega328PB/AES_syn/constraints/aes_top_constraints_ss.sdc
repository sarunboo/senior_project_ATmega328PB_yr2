...
# Assume 20MHz for clk and Assume 10MHz for SPI SCK
create_clock -name CLK -period 50 [ get_ports "clk" ]
create_clock -name CLK2 -period 50 [ get_ports "sck" ]
...
set_input_delay 10 -clock CLK2             [all_inputs ]
set_output_delay 10 -clock CLK2             [all_outputs]


# Clock signals
remove_input_delay                        [get_ports "clk" ]
remove_input_delay                        [get_ports "sck" ]
# Reset signals
...
remove_driving_cell [get_ports "sck"]
set_driving_cell -lib_cell CLKBUFHDV32  [get_ports "sck"]
...
report_clocks > /nfs/mcu8b/sarun/AES_syn/outputs/${TOP_DESIGN_NAME}.report_clock_ss.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/AES_syn/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ss.rpt