...
report_clocks > /nfs/mcu8b/sarun/AES_syn/outputs/${TOP_DESIGN_NAME}.report_clock.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/AES_syn/outputs/${TOP_DESIGN_NAME}.report_disable_timing.rpt