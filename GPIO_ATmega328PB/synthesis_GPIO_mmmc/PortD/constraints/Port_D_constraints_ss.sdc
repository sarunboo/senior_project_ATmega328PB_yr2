...
set TARGET_LIBRARY      "scc013ull_hd_rvt_ss_v1p08_125c_basic"
...
set_false_path -from [get_ports pinD_i[0]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[0]/D]
set_false_path -from [get_ports pinD_i[1]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[1]/D]
set_false_path -from [get_ports pinD_i[2]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[2]/D]
set_false_path -from [get_ports pinD_i[3]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[3]/D]
set_false_path -from [get_ports pinD_i[4]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[4]/D]
set_false_path -from [get_ports pinD_i[5]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[5]/D]
set_false_path -from [get_ports pinD_i[6]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[6]/D]
set_false_path -from [get_ports pinD_i[7]] -to [get_pins IO_Port_D_inst/synchronizer_pinx_inst/d_latch_reg[7]/D]
# ------------------------------------------------------------------------------
...
#set_load -max [ load_of scc013ull_hd_rvt_ss_v1p08_125c_basic/DQHDV0/D] [all_outputs]
#set_load -min [ load_of scc013ull_hd_rvt_ss_v1p08_125c_basic/DQHDV0/D] [all_outputs]
...
report_clocks > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortD/outputs/${TOP_DESIGN_NAME}.report_clock_ss.rpt
#report_clock_tree > outputs/${TOP_DESIGN_NAME}.report_clock_tree_ss.rpt
#report_clock_tree -summary > outputs/${TOP_DESIGN_NAME}.report_clock_tree.summary_ss.rpt
# report_interclock_relation > outputs/${TOP_DESIGN_NAME}.report_interclock_relation.rpt
report_disable_timing > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortD/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ss.rpt