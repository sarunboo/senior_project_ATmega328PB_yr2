...
report_clocks > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_clock.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_disable_timing.rpt