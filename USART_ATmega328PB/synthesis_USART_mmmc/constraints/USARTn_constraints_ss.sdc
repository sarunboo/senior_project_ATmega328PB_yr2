...
report_clocks > /nfs/mcu8b/sarun/synthesis_USART_mmmc/outputs/${TOP_DESIGN_NAME}.report_clock_ss.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/synthesis_USART_mmmc/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ss.rpt