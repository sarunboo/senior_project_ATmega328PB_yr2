...
#set_load -max [ load_of /nfs/mcu8b/jirath/01lib/scc013ull_hd_rvt_ff_v1p32_-40c_basic/DQHDV0/D] [all_outputs]
#set_load -min [ load_of /nfs/mcu8b/jirath/01lib/scc013ull_hd_rvt_ff_v1p32_-40c_basic/DQHDV0/D] [all_outputs]
...
report_clocks > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortD/outputs/${TOP_DESIGN_NAME}.report_clock_ff.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortD/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ff.rpt