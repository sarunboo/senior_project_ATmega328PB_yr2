#################################################################################
#
# Created by Genus(TM) Synthesis Solution 22.10-p001_1 on Wed Mar 12 23:42:10 +07 2025
#
#################################################################################
...
create_constraint_mode -name functional_ss_v1p08_125c \
    -sdc_files { /nfs/mcu8b/sarun/synthesis_USART_mmmc/constraints/USARTn_constraints_ss.sdc }
create_constraint_mode -name functional_ff_v1p32 \
    -sdc_files { /nfs/mcu8b/sarun/synthesis_USART_mmmc/constraints/USARTn_constraints_ff.sdc }
create_constraint_mode -name functional_tt_v1p5_25c \
    -sdc_files { /nfs/mcu8b/sarun/synthesis_USART_mmmc/constraints/USARTn_constraints_tt.sdc }
