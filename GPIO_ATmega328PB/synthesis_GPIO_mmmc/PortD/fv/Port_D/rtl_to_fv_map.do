...
# Generated on: Wed Mar 12 23:46:44 +07 2025 (Wed Mar 12 16:46:44 UTC 2025)
...
set logfile fv/Port_D/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Port_D -revised fv_map
...
add_search_path /nfs/mcu8b/sarun/current_GPIO/portD/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /nfs/mcu8b/sarun/current_GPIO/portD/Port_D.sv /nfs/mcu8b/sarun/current_GPIO/portD/IO_Port.sv /nfs/mcu8b/sarun/current_GPIO/portD/rg_md.sv /nfs/mcu8b/sarun/current_GPIO/portD/synchronizer.sv
elaborate_design -golden -root {Port_D} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Port_D/fv_map.v.gz
elaborate_design -revised -root {Port_D}
...
#add_name_alias fv/Port_D/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Port_D.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Port_D.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Port_D.rtl.fv_map.rpt
