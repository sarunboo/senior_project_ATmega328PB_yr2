...
# Generated on: Wed Mar 12 23:45:48 +07 2025 (Wed Mar 12 16:45:48 UTC 2025)
...
set logfile fv/Port_B/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Port_B -revised fv_map
...
add_search_path /nfs/mcu8b/sarun/current_GPIO/portB/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /nfs/mcu8b/sarun/current_GPIO/portB/Port_B.sv /nfs/mcu8b/sarun/current_GPIO/portB/IO_Port.sv /nfs/mcu8b/sarun/current_GPIO/portB/rg_md.sv /nfs/mcu8b/sarun/current_GPIO/portB/synchronizer.sv
elaborate_design -golden -root {Port_B} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Port_B/fv_map.v.gz
elaborate_design -revised -root {Port_B}
...
#add_name_alias fv/Port_B/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Port_B.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Port_B.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Port_B.rtl.fv_map.rpt
