...
# Generated on: Wed Mar 12 23:42:24 +07 2025 (Wed Mar 12 16:42:24 UTC 2025)
...
set logfile fv/USARTn/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/USARTn -revised fv_map
...
add_search_path /nfs/mcu8b/sarun/current_USART/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /nfs/mcu8b/sarun/current_USART/USARTn.sv /nfs/mcu8b/sarun/current_USART/FIFO.sv /nfs/mcu8b/sarun/current_USART/USART_Clk.sv
elaborate_design -golden -root {USARTn} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/USARTn/fv_map.v.gz
elaborate_design -revised -root {USARTn}
...
#add_name_alias fv/USARTn/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.USARTn.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.USARTn.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.USARTn.rtl.fv_map.rpt
