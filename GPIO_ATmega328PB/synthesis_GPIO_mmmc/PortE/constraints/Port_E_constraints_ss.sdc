...
set_false_path -from [get_ports pinE_i[0]] -to [get_pins IO_Port_E_inst/synchronizer_pinx_inst/d_latch_reg[0]/D]
set_false_path -from [get_ports pinE_i[1]] -to [get_pins IO_Port_E_inst/synchronizer_pinx_inst/d_latch_reg[1]/D]
set_false_path -from [get_ports pinE_i[2]] -to [get_pins IO_Port_E_inst/synchronizer_pinx_inst/d_latch_reg[2]/D]
set_false_path -from [get_ports pinE_i[3]] -to [get_pins IO_Port_E_inst/synchronizer_pinx_inst/d_latch_reg[3]/D]
# ------------------------------------------------------------------------------
...
report_clocks > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_clock_ss.rpt
...
report_disable_timing > /nfs/mcu8b/sarun/synthesis_GPIO_mmmc/PortE/outputs/${TOP_DESIGN_NAME}.report_disable_timing_ss.rpt